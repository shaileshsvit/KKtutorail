...
//	private DataSource dataSource;
	...
	public void createEmployee(Employee employee) {
		...
		int update=jdbcTemplate.update(sql,employee.getEmployeeName(),employee.getSalary(),employee.getEmail(),employee.getGender());
...
Employee emp=jdbcTemplate.queryForObject(sql, new EmplyeeRowMapper(),employeeId);
return emp;
...
if(update>0)
	...
	public List<Employee> getAllEmployeesDetails() {
		...
		List<Employee> list=jdbcTemplate.query(sql, new EmplyeeRowMapper());
